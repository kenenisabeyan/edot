...
export const getDashboardData = async (req, res) => {
  try {
    // SEED DATA IF EMPTY (just for demonstration ensuring dynamic fetching has content)
    ...
    // 4. ACTIVE SUPPORT CYCLE (Primary focus currently supported)
