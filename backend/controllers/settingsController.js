...
export const updateSettings = async (req, res) => {
  try {
    ...
    // Note: Prisma schema flattened the settings into a single level model. 
    // Earlier versions had `settings[role]` and `settings.common`. 
    // We map commonData and role specific data to the top level fields.
    ...
    // Mapping Role specific properties
    if (settingsData) {
      if (role === 'student') {
    ...
    // Structure response back into nested object to match UI expectations
