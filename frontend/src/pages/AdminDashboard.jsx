    ...
    switch (activeTab) {
      case 'overview': {
        ...
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h2 className="text-2xl font-display font-bold text-white mb-6">Admin Overview</h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
              <div className="bg-[#13161B] p-6 rounded-2xl border border-white/10 shadow-sm relative overflow-hidden group">
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <h3 className="text-3xl font-bold text-white">{usersList.length}</h3>
                  </div>
              ...
              <div className="bg-[#13161B] p-6 rounded-2xl border border-rose-200 shadow-sm relative overflow-hidden group hover:border-rose-300">
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <h3 className="text-3xl font-bold text-white">{stats?.pendingUsers || 0}</h3>
                  </div>
                  <div className="w-8 h-8 rounded shrink-0 border border-white/10 flex items-center justify-center text-slate-400 bg-transparent">
              ...
              <div className="bg-[#13161B] p-6 rounded-2xl border border-white/10 shadow-sm relative overflow-hidden group">
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <p className="text-sm font-medium text-slate-300 mb-1">Instructors</p>
                    <h3 className="text-3xl font-bold text-white">{instructorsCount}</h3>
                  </div>
                  <div className="w-8 h-8 rounded shrink-0 border border-white/10 flex items-center justify-center text-slate-400 bg-transparent">
              ...
              <div className="bg-[#13161B] p-6 rounded-2xl border border-white/10 shadow-sm relative overflow-hidden group">
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <p className="text-sm font-medium text-slate-300 mb-1">Pending Approvals</p>
                    <h3 className="text-3xl font-bold text-white">{pendingCourses.length}</h3>
                  </div>
                  <div className="w-8 h-8 rounded shrink-0 border border-white/10 flex items-center justify-center text-slate-400 bg-transparent">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              <div className="bg-[#13161B] p-6 rounded-2xl border border-white/10 shadow-sm">
                <h3 className="text-lg font-bold text-white mb-6">Revenue Overview (YTD)</h3>
            ...
            <div className="bg-[#13161B] p-6 lg:p-8 rounded-2xl border border-white/10 shadow-sm">
               <h3 className="text-xl font-bold text-white mb-6">Quick Actions</h3>
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 <button 
                  onClick={() => setActiveTab('users')} 
                  className="flex items-center gap-3 p-4 rounded-xl border border-white/10 hover:border-blue-300 hover:bg-blue-500/10 hover:text-blue-700 transition-colors text-left group"
                 >
                   ...
                   <div>
                     ...
                     <span className="text-sm text-slate-300 group-hover:text-blue-600">{stats?.pendingUsers > 0 ? <span className="text-rose-500 font-bold">{stats.pendingUsers} awaiting approval</span> : 'Change roles, verify status'}</span>
                   </div>
                 </button>
                 <button 
                  onClick={() => setActiveTab('courses')} 
                  className="flex items-center gap-3 p-4 rounded-xl border border-white/10 hover:border-amber-300 hover:bg-amber-500/10 hover:text-amber-700 transition-colors text-left group"
                 >
                   ...
                   <div>
                     ...
                     <span className="text-sm text-slate-300 group-hover:text-amber-600">{pendingCourses.length} awaiting approval</span>
                   </div>
                 </button>
               </div>
            </div>

            <div className="bg-[#13161B] p-6 lg:p-8 rounded-2xl border border-white/10 shadow-sm mt-8">
               <div className="flex justify-between items-center mb-6">
                 <h3 className="text-xl font-bold text-white">Intervention Overview</h3>
               ...
               <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                 <div className="p-4 rounded-xl border border-white/5 bg-transparent flex items-center gap-5 hover:shadow-sm transition-shadow">
                   <div className="w-14 h-14 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center shrink-0">
                     <MessageSquare className="w-6 h-6"/>
                   </div>
                   <div>
                     <p className="text-[13px] text-slate-300 font-bold uppercase tracking-wide mb-1">Active Parent Chats</p>
                     <h4 className="text-3xl font-black text-white">12</h4>
                   </div>
                 </div>
                 <div className="p-4 rounded-xl border border-white/5 bg-rose-500/10 flex items-center gap-5 hover:shadow-sm transition-shadow">
        ...
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              ...
              <div className="bg-[#13161B] px-4 py-2 rounded-lg border border-white/10 text-sm font-medium text-slate-300 shadow-sm flex items-center gap-2">
                <ShieldCheck className="w-4 h-4 text-emerald-500" />
                Super Admin Access
              </div>
            </div>
            
            <div className="bg-[#13161B] rounded-2xl border border-white/10 shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse min-w-[800px]">
                  <thead>
                    <tr className="bg-transparent border-b border-white/10 text-slate-300 text-sm uppercase tracking-wider">
                      ...
                      <tr key={u.id} className="hover:bg-transparent/50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-[#11151F]/5 backdrop-blur-xl text-slate-300 flex flex-shrink-0 items-center justify-center font-bold text-xs">
                        ...
                        <td className="px-6 py-4 text-slate-300">{new Date(u.createdAt || Date.now()).toLocaleDateString(undefined, { year: 'numeric', month: 'short', day: 'numeric' })}</td>
                        <td className="px-6 py-4">
                          {u.status === 'pending' ? (
                        ...
                        <td className="px-6 py-4">
                          <button
                            className="px-3 py-1.5 rounded-lg border border-amber-200 bg-amber-500/10 text-amber-700 text-xs font-semibold hover:bg-amber-100 flex items-center gap-1"
      ...
      case 'courses':
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-display font-bold text-white">Course Approvals</h2>
            ...
            {pendingCourses.length === 0 ? (
               <div className="bg-[#13161B] p-12 text-center rounded-2xl border border-white/10 shadow-sm flex flex-col items-center justify-center">
                 ...
                 <p className="text-slate-300 max-w-sm">There are no pending courses awaiting your review. Check back later.</p>
               </div>
            ) : (
                <div className="grid grid-cols-1 gap-6">
                  {pendingCourses.map(c => (
                    <div key={c.id} className="bg-[#13161B] rounded-2xl border border-white/10 shadow-sm overflow-hidden flex flex-col md:flex-row group">
                      
                      <div className="w-full md:w-64 h-48 md:h-auto shrink-0 relative bg-[#11151F]/5 backdrop-blur-xl">
                        <img 
                        ...
                        />
                        <div className="absolute top-3 left-3 bg-[#13161B]/90 backdrop-blur-sm px-2.5 py-1 rounded-md text-xs font-bold text-slate-200 uppercase tracking-wider shadow-sm">
                          {c.category}
                        </div>
                      </div>
                      ...
                      <div className="p-6 md:p-8 flex flex-col flex-1">
                        <div className="flex justify-between items-start mb-2 gap-4">
                          ...
                          <span className="shrink-0 flex items-center gap-1.5 bg-amber-500/10 text-amber-700 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider border border-amber-200">
                             <Clock className="w-3 h-3" /> Pending Review
                          </span>
                        </div>
                        
                        <p className="text-slate-300 text-sm mb-4 flex flex-wrap items-center gap-x-2 gap-y-1">
                          <span className="flex items-center gap-1"><UserCog className="w-4 h-4" /> Instructor: <span className="font-semibold text-slate-200">{c.instructor?.name || 'Unknown'}</span></span>
                        ...
                        <p className="text-slate-300 mb-6 flex-1 line-clamp-3">{c.description}</p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-white/5">
                           ...
                           <button 
                            ...
                            className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-[#13161B] text-red-600 font-semibold rounded-xl border border-red-200 hover:bg-red-50 hover:-translate-y-0.5 transition-all shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500"
                           >
            ...
            <div className="mt-8 bg-[#13161B] p-6 rounded-2xl border border-white/10 shadow-sm">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-white">Enrollment Approval Queue</h3>
                <span className="text-sm text-slate-300">{pendingEnrollments.length} pending</span>
              </div>
              {!pendingEnrollments.length ? (
                <p className="text-slate-300">No pending enrollment requests.</p>
              ) : (
                <div className="space-y-3">
                  {pendingEnrollments.map((req) => (
                    <div key={req.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 border border-white/10 rounded-lg">
                      <div>
                        ...
                        <p className="text-xs text-slate-200">Requested at: {new Date(req.requestedAt).toLocaleString()}</p>
                      </div>
                      <div className="flex gap-2">
                        <button onClick={() => handleEnrollmentApproval(req.id, 'active')} className="px-3 py-1.5 bg-emerald-600 text-white rounded-lg text-xs">Approve</button>
                        <button onClick={() => handleEnrollmentApproval(req.id, 'rejected')} className="px-3 py-1.5 bg-rose-500/100 text-white rounded-lg text-xs">Reject</button>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      case 'logs':
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h2 className="text-2xl font-display font-bold text-white mb-6">System Logs</h2>
            <div className="bg-[#13161B] p-6 rounded-2xl border border-white/10 shadow-sm">
                <div className="flex justify-between items-center mb-6">
                  <span className="font-semibold text-slate-200 flex items-center gap-2"><Activity className="w-5 h-5" /> All Platform Activity</span>
                  <button className="text-sm text-blue-600 hover:text-blue-800 font-semibold px-3 py-1.5 bg-blue-500/10 rounded-lg transition-colors">Export CSV</button>
                </div>
      ...
      case 'settings':
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-3xl">
            <h2 className="text-2xl font-display font-bold text-white mb-6">Administrator Settings</h2>
            
            <div className="bg-[#13161B] p-6 md:p-8 rounded-2xl border border-white/10 shadow-sm">
              ...
              <div className="p-4 bg-amber-500/10 border border-amber-200 rounded-xl flex items-start gap-3 text-amber-800 mb-8">
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input 
                    ...
                    disabled 
                    className="w-full px-4 py-3 rounded-lg border border-white/10 bg-[#11151F]/5 backdrop-blur-xl text-slate-300 cursor-not-allowed" 
                  />
                  <p className="mt-1.5 text-xs text-slate-300">Contact IT support to change your administrator display name.</p>
                </div>
                <div>
           ...
           <nav className="space-y-2">
             ...
             <button onClick={() => setActiveTab('users')} className={navItemClass('users')}>
               ...
               {stats?.pendingUsers > 0 && (
                 <span className="ml-auto bg-rose-500/100 text-white text-xs font-bold px-2 py-0.5 rounded-full">
                   {stats?.pendingUsers}
                 </span>
               )}
             </button>
             <button onClick={() => setActiveTab('courses')} className={navItemClass('courses')}>
               ...
               {pendingCourses.length > 0 && (
                 <span className="ml-auto bg-amber-500/100 text-white text-xs font-bold px-2 py-0.5 rounded-full">
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-5">
                  <div className="p-4 rounded-2xl border border-white/10 bg-black/40">
                    ...
                    {selectedUser.role === 'student' && (
                      <div className="space-y-2">
                        <p className="text-xs text-slate-200">Assigned Instructor</p>
                        {selectedUser.assignedInstructor ? (
                          ...
                          <p className="text-sm text-slate-200">Unassigned</p>
                        )}

                        <p className="text-xs text-slate-200">Linked Parents</p>
                        <div className="flex flex-wrap gap-2">
                          {(selectedUser.parents || []).length > 0 ?
                            ...
                            )) : <p className="text-sm text-slate-200">No parents connected</p>
                          }
                        </div>
                      </div>
                    )}
                      ...
                      {(selectedUserActivities.length > 0) ? selectedUserActivities.map((activity) => (
                        <div key={activity.id} className="rounded-lg border border-slate-700 bg-slate-900/70 p-2 text-xs">
                          <div className="flex justify-between items-start">
                             ...
                             {activity.metadata?.ip && <span className="text-[9px] text-slate-300 font-mono tracking-tighter bg-black/50 px-1 rounded">{activity.metadata.ip}</span>}
                          </div>
                          <p className="text-slate-200 mt-0.5 text-[11px]">{activity.type || 'action'} • {new Date(activity.createdAt).toLocaleString()} {activity.metadata?.userAgent?.includes('Mobi') ? '📱' : '💻'}</p>
                        </div>
                      )) : <p className="text-slate-200 text-sm">No recent activity recorded.</p>}
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-2xl border border-white/10 bg-black/40">
                    ...
                    <div className="flex flex-col gap-4">
                      <div>
                        <p className="text-[10px] text-slate-300 uppercase font-bold tracking-wider mb-1">Total courses / Active Classes</p>
                      ...
                      <div>
                        <p className="text-[10px] text-slate-300 uppercase font-bold tracking-wider mb-1">Pending approvals</p>
                      ...
                      <div>
                        <p className="text-[10px] text-slate-300 uppercase font-bold tracking-wider mb-1">Last activity</p>
                    ...
                    {(selectedUser.role === 'student') ? (
                      <>
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          <button onClick={() => manualEnrollment(allCourses[0]?.id || '', 'active')} className="px-3 py-2 bg-blue-600 rounded-lg text-xs text-white">Force Enroll</button>
                          ...
                          {selectedUser.status === 'blocked' ? (
                            <button onClick={async () => { await updateUserStatus(selectedUser.id, 'approved'); await openManagePanel(selectedUser.id); }} className="px-3 py-2 bg-emerald-600 rounded-lg text-xs text-white">Unblock Service</button>
                          ) : (
                      ...
                      <>
                        ...
                        <div className="space-y-2">
                          ...
                          {(selectedUserCourses.length === 0) ? <p className="text-xs text-slate-200">No created content yet</p> : selectedUserCourses.map((c) => (
                          ...
                          )) : <p className="text-xs text-slate-200">No feedback yet</p>}
                      ...
                      <>
                        ...
                        <div className="space-y-2">
                          {(selectedUser.children || []).length > 0 ?
                            ...
                            )) : <p className="text-xs text-slate-200">No current children linked</p>
                          }
                        </div>
                        <div className="mt-2">
                          <h5 className="text-xs text-slate-200 uppercase tracking-wide">Add/Remove Child</h5>
                          <div className="flex gap-2 mt-1">
                            <CustomDropdown 
                              ...
                              options={filterCandidates().map(child => ({ 
                                ...
                                render: (
                                  <div className="flex items-center gap-3 w-full py-0.5">
                                    <div className="w-8 h-8 rounded-full bg-blue-500/100/20 text-blue-400 flex items-center justify-center font-bold text-xs shrink-0 border border-blue-500/30 shadow-sm uppercase">
                                        {child.name ? child.name.charAt(0) : '?'}
                                    </div>
                                    <div className="flex flex-col text-left flex-1 min-w-0">
                                      <span className="font-bold text-white text-xs truncate">{child.name}</span>
                                      <span className="text-[10px] text-slate-200 truncate mt-0.5">{child.email}</span>
                                    </div>
                                  </div>
                                )
                              }))}
                        ...
                        <div className="mt-2">
                          <h5 className="text-xs text-slate-200 uppercase tracking-wide">Family Activity</h5>
                          <div className="max-h-28 overflow-auto space-y-1 mt-1">
                            {(recentFamilyActivity.length > 0) ? recentFamilyActivity.map((act) => (
                              <p key={act.id} className="text-xs text-slate-300">{new Date(act.createdAt).toLocaleString()} — {act.action}</p>
                            )) : <p className="text-xs text-slate-200">No family insights yet</p>}
                          </div>
                        </div>
                      </>
                    ) : (
                ...
                <div className="mt-6 p-4 rounded-2xl border border-white/10 bg-black/40">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 items-end">
                    ...
                    <div>
                      <label className="text-xs text-slate-200">Password (min 6 chars)</label>
                      <input
                        type="password"
                    ...
                    <div>
                      <label className="text-xs text-slate-200">Account Status</label>
                      <CustomDropdown
                ...
                <div className="mt-5 p-4 rounded-2xl border border-white/10 bg-black/40 grid grid-cols-1 md:grid-cols-2 gap-3">
                  <button onClick={saveUserUpdates} className="px-4 py-2 rounded-lg bg-emerald-500/100 text-white font-semibold text-sm">Save changes</button>
                  <button onClick={() => deleteAdminUser(selectedUser.id)} className="px-4 py-2 rounded-lg bg-rose-500/100 text-white font-semibold text-sm">Delete user</button>
                </div>
              </motion.div>
            </motion.div>
          )}
