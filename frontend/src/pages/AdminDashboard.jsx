        ...
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
              <div className="glass-card p-6 rounded-2xl border border-white/10 shadow-sm relative overflow-hidden group">
            ...
            <div className="glass-card p-6 lg:p-8 rounded-2xl border border-white/10 shadow-sm">
            ...
            <div className="glass-card p-6 lg:p-8 rounded-2xl border border-white/10 shadow-sm mt-8">
        ...
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              ...
              <div className="glass-card px-4 py-2 rounded-lg border border-white/10 text-sm font-medium text-slate-300 shadow-sm flex items-center gap-2">
        ...
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {pendingCourses.length === 0 ? (
               <div className="glass-card p-12 text-center rounded-2xl border border-white/10 shadow-sm flex flex-col items-center justify-center">
                ...
                <div className="grid grid-cols-1 gap-6">
                  {pendingCourses.map(c => (
                    <div key={c.id} className="glass-card rounded-2xl border border-white/10 shadow-sm overflow-hidden flex flex-col md:flex-row group">
                      ...
                      <div className="w-full md:w-64 h-48 md:h-auto shrink-0 relative bg-[#11151F]/5 backdrop-blur-xl">
                        ...
                        />
                        <div className="absolute top-3 left-3 glass-card/90 backdrop-blur-sm px-2.5 py-1 rounded-md text-xs font-bold text-slate-200 uppercase tracking-wider shadow-sm">
                          {c.category}
                        </div>
                      </div>
            ...
            <div className="mt-8 glass-card p-6 rounded-2xl border border-white/10 shadow-sm">
      ...
      case 'settings':
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-3xl">
            ...
            <div className="glass-card p-6 md:p-8 rounded-2xl border border-white/10 shadow-sm">
