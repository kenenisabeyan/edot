  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-stretch bg-gray-50 font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#111111] relative flex-col items-center justify-center text-center px-12 overflow-hidden border-r-4 border-[#FFC107]">
        {/* Geometric Accents */}
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-[#FFC107]/10 rounded-full blur-3xl translate-y-1/3 translate-x-1/3"></div>
        <div className="absolute top-0 left-0 w-80 h-80 bg-[#FFC107]/5 rounded-full blur-3xl -translate-y-1/3 -translate-x-1/3"></div>
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-[#FFC107] text-5xl font-black mb-4 tracking-tighter uppercase">Join EDOT Hub</h2>
          <p className="text-white/80 text-lg font-medium">Create your dedicated account to unlock our premium educational platform.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white overflow-y-auto">
        <div className="w-full max-w-md py-8">
          ...
          <h2 className="text-3xl font-black text-[#111111] text-center mb-8 uppercase tracking-tight">Registration</h2>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="mb-4">
              <label className="block text-sm font-bold text-[#111111] mb-2 uppercase tracking-wide">Full Name</label>
              <input 
                type="text" 
                id="name" 
                name="name" 
            ...
            <div className="mb-4">
              <label className="block text-sm font-bold text-[#111111] mb-2 uppercase tracking-wide">Email</label>
              <input 
                type="email" 
                id="email" 
                name="email" 
            ...
            <div className="mb-4 relative">
              <label className="block text-sm font-bold text-[#111111] mb-2 uppercase tracking-wide">Password</label>
            ...
            <div className="mb-6 relative">
              <label className="block text-sm font-bold text-[#111111] mb-2 uppercase tracking-wide">Confirm Password</label>
              <div className="relative">
                 <input 
            ...
            <div className="flex items-start mb-8">
              <input 
                ...
                onChange={handleChange}
                className="mt-1 h-4 w-4 text-[#FFC107] focus:ring-[#FFC107] border-gray-300 rounded-sm cursor-pointer"
              />
              <label htmlFor="agreeTerms" className="ml-3 block text-sm font-bold text-gray-600 leading-snug cursor-pointer">
                I agree to the <Link to="/terms" className="text-[#111111] hover:text-[#FFC107] underline underline-offset-4">Terms</Link> and <Link to="/privacy" className="text-[#111111] hover:text-[#FFC107] underline underline-offset-4">Privacy Policy</Link>
              </label>
            </div>
            ...
            <button 
              ...
              className="w-full flex items-center justify-center py-4 px-4 rounded-sm text-[#111111] font-black uppercase tracking-widest bg-[#FFC107] hover:bg-[#e0a800] focus:outline-none transition-all disabled:opacity-70 shadow-sm hover:shadow-md"
            >
              {loadingSubmit ? (
            ...
            <div className="mt-8 text-center bg-gray-50 p-4 border border-gray-200 rounded-sm">
              <p className="text-sm font-bold text-gray-600">
                Already have an Account? <Link to="/login" className="text-[#111111] hover:text-[#FFC107] underline underline-offset-4 ml-1 transition-colors">Sign in here</Link>
              </p>
            </div>
