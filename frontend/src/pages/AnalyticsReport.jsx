    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#0B0E14]/90 backdrop-blur-xl p-6 rounded-3xl border border-white/10 shadow-2xl">
        <div className="flex items-center gap-4">
          <button 
            onClick={() => navigate(-1)} 
            className="p-3 bg-white/5 hover:bg-white/10 rounded-full transition-colors text-slate-400 hover:text-white border border-white/5"
          >
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 bg-white/5 hover:bg-white/10 text-white px-5 py-2.5 rounded-xl font-bold text-sm transition-colors border border-white/10">
        ...
        <div className="space-y-6">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             <div className="bg-gradient-to-br from-[#FFD700] to-yellow-600 rounded-3xl p-6 text-black shadow-[0_0_30px_rgba(255,215,0,0.2)] relative overflow-hidden group hover:-translate-y-1 transition-all cursor-pointer">
               <div className="absolute right-0 top-0 w-32 h-32 bg-white/20 rounded-full blur-2xl group-hover:bg-white/30 transition-all"></div>
             ...
             <div className="bg-[#0B0E14]/90 backdrop-blur-xl p-6 rounded-3xl border border-white/10 shadow-2xl flex flex-col justify-between group hover:-translate-y-1 transition-all cursor-pointer relative overflow-hidden">
               <div className="absolute right-[-10%] top-[-10%] w-32 h-32 bg-blue-500/20 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
               <div className="flex justify-between items-center mb-4 relative z-10">
                 <div className="p-3 bg-blue-500/10 border border-blue-500/30 text-blue-400 rounded-xl"><BookOpen className="w-6 h-6" /></div>
               </div>
               <div className="relative z-10">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div className="bg-gradient-to-br from-[#1a1f2e] to-[#0B0E14] p-8 rounded-3xl border border-white/5 shadow-inner flex flex-col justify-center relative overflow-hidden">
               ...
               <p className="text-slate-400 font-medium leading-relaxed text-sm mb-6 relative z-10">
               ...
               <button className="self-start text-xs font-black uppercase tracking-widest bg-white/10 text-white px-6 py-3 rounded-xl hover:bg-white/20 transition-all border border-white/10 relative z-10 hover:shadow-lg">
                 Generate Briefing
               </button>
             </div>
           </div>
