        ...
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
              ...
              <div className="bg-[#0B0E14]/90 backdrop-blur-xl p-6 rounded-2xl border border-white/10 shadow-2xl relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-32 h-32 bg-purple-500/100 rounded-bl-full opacity-5 group-hover:scale-110 transition-transform"></div>
                <div className="flex justify-between items-start mb-4">
                  <div>
                  ...
                  <div className="w-12 h-12 bg-[#11151F]/5 border border-white/10 text-purple-400 rounded-xl flex items-center justify-center">
            ...
            {enrolledCourses.length === 0 ? (
               <div className="bg-[#0B0E14]/50 backdrop-blur-xl p-10 text-center rounded-2xl border-2 border-dashed border-white/10 shadow-sm flex flex-col items-center">
                 <div className="w-16 h-16 bg-[#11151F]/5 text-slate-300 rounded-full flex items-center justify-center mb-4">
                   <BookOpen className="w-8 h-8" />
                 </div>
                 <p className="text-slate-200 font-bold tracking-wide mb-6">You aren't enrolled in any courses yet to track progress.</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {enrolledCourses.slice(0, 3).map((enrolled) => (
                    <div key={enrolled.id || enrolled.course?.id} className="bg-[#0B0E14]/90 backdrop-blur-xl p-6 rounded-2xl border border-white/10 shadow-2xl hover:border-[#FFD700]/50 transition-all group flex flex-col h-full relative overflow-hidden">
                      <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFD700] rounded-bl-full opacity-5 pointer-events-none"></div>
                      <div className="flex-1 relative z-10">
                        <div className="w-12 h-12 bg-[#11151F]/5 text-[#FFD700] rounded-xl border border-[#FFD700]/30 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:shadow-[0_0_15px_rgba(255,215,0,0.3)] transition-all">
                          <PlayCircle className="w-6 h-6" />
                        </div>
                        <h4 className="font-bold text-white mb-6 line-clamp-2 leading-snug text-lg">{enrolled.course?.title || 'Unknown Course'}</h4>
                        
                        <div className="flex justify-between text-xs font-black uppercase tracking-widest mb-2 text-slate-200">
                          <span>Progress</span>
                        ...
                        <div className="h-2 bg-[#11151F] rounded-full mb-8 overflow-hidden shadow-inner">
                          ...
                          >
                           <div className="absolute top-0 bottom-0 left-0 right-0 bg-[#11151F]/20 animate-[progress_2s_ease-in-out_infinite]"></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <Link 
                        ...
                        className="w-full inline-flex justify-center items-center px-4 py-3 bg-[#11151F]/5 text-white font-bold uppercase tracking-widest text-xs rounded-xl border border-white/10 hover:bg-[#FFD700] hover:text-[#0B0E14] hover:border-[#FFD700] transition-colors relative z-10"
                      >
                        Continue Learning
                      </Link>
                    </div>
        ...
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              ...
              <Link to="/courses" className="inline-flex items-center gap-2 px-6 py-3 bg-[#11151F]/5 text-[#FFD700] font-black uppercase tracking-widest text-[11px] rounded-xl border border-white/10 hover:bg-[#FFD700] hover:text-[#0B0E14] hover:border-[#FFD700] transition-colors shadow-sm">
            ...
            {enrolledCourses.length === 0 ? (
               <div className="bg-[#0B0E14]/50 backdrop-blur-xl p-12 text-center rounded-2xl border-2 border-dashed border-white/10 shadow-sm flex flex-col items-center justify-center">
                 ...
                 <p className="text-slate-200 max-w-sm mb-6">You haven't enrolled in any courses. Discover your next passion today.</p>
                  ...
                  {enrolledCourses.map((enrolled) => (
                    ...
                    >
                      ...
                      <div className="flex-1 w-full">
                        ...
                        <p className="text-slate-200 text-[13px] font-bold uppercase tracking-wide mb-4">
        ...
        return (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {completedCourses.length === 0 ? (
               <div className="bg-[#0B0E14]/50 backdrop-blur-xl p-12 text-center rounded-2xl border-2 border-dashed border-white/10 shadow-sm flex flex-col items-center justify-center">
                 <div className="w-20 h-20 bg-[#11151F]/5 text-purple-500 rounded-full flex items-center justify-center mb-4 border border-white/10">
                   <Award className="w-10 h-10" />
                 </div>
                 <h3 className="text-xl font-bold text-white mb-2">No credentials yet</h3>
                 <p className="text-slate-200 max-w-sm mb-6">Complete courses to 100% to earn your official certificates.</p>
                 <button 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {completedCourses.map((enrolled) => (
                    ...
                    >
                      <div className="absolute top-0 right-0 w-32 h-32 bg-purple-500/100 rounded-bl-full opacity-5 pointer-events-none group-hover:scale-110 transition-transform"></div>
                      <div className="w-20 h-20 bg-[#11151F]/5 text-purple-400 rounded-2xl flex items-center justify-center mb-6 mx-auto border border-purple-500/30 shadow-[0_0_20px_rgba(168,85,247,0.2)]">
                        <Award className="w-10 h-10" />
                      </div>
                      ...
                      <button 
                        ...
                        className="w-full inline-flex justify-center items-center gap-2 px-6 py-3.5 bg-[#11151F]/5 text-white font-bold uppercase tracking-widest text-[11px] rounded-xl border border-white/10 hover:bg-purple-500/100 hover:border-purple-400 transition-colors shadow-sm relative z-10"
                      >
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-[#0B0E14]/90 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl mb-10 relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
                  <div className="bg-[#11151F] border border-white/10 p-6 rounded-2xl flex-1 w-full flex flex-col items-center justify-center h-full hover:border-[#FFD700]/30 transition-colors">
                    <p className="text-slate-200 text-[10px] font-black uppercase tracking-widest mb-2">Current Tier</p>
                  ...
                  <div className="bg-[#11151F] border border-white/10 p-6 rounded-2xl flex-1 w-full flex flex-col items-center justify-center h-full hover:border-[#008A32]/30 transition-colors">
                    <p className="text-slate-200 text-[10px] font-black uppercase tracking-widest mb-2">Total Learning UX</p>
                    ...
                    <div className="flex flex-wrap gap-4">
                      {achievements.badges.map((badge, idx) => (
                        <div key={idx} className="bg-[#11151F] border border-white/10 p-4 rounded-xl flex items-center gap-4 shadow-sm">
                          <div className="w-12 h-12 rounded-lg bg-[#11151F]/5 flex items-center justify-center border border-[#FFD700]/20 text-[#FFD700]">
                            <Award className="w-6 h-6"/>
                          </div>
                          <div>
                            <h4 className="font-bold text-white tracking-wide">{badge.title}</h4>
                            <p className="text-[11px] font-medium text-slate-200 max-w-[150px] truncate">{badge.description}</p>
                          </div>
                        </div>
                      ))}
                    </div>
            ...
            <div className="bg-[#0B0E14]/90 backdrop-blur-xl p-6 md:p-8 rounded-3xl border border-white/10 shadow-2xl mb-10">
              ...
              <form onSubmit={handleAddGoal} className="flex flex-col sm:flex-row gap-4">
                <input 
                  ...
                  className="flex-1 px-6 py-4 bg-[#11151F] text-white font-medium border border-white/10 rounded-xl focus:ring-2 focus:ring-[#008A32] outline-none transition-all placeholder:text-slate-300"
                  required
                />
            ...
            <div className="space-y-4">
              {privateLogs.length === 0 ? (
                 <div className="bg-[#0B0E14]/50 border-2 border-dashed border-white/10 p-10 text-center rounded-2xl shadow-sm text-slate-300 font-bold tracking-wide">
                   Execution log empty. Record your first private victory.
                 </div>
              ) : (
                privateLogs.map(log => (
                  <div key={log.id} className="bg-[#11151F] border border-white/5 hover:border-[#008A32]/30 p-6 rounded-2xl flex flex-col justify-between gap-4 transition-all">
                     <div>
                       <div className="flex items-center gap-2 mb-2">
                         ...
                         <span className="text-slate-300 text-[11px] font-bold tracking-widest uppercase">{new Date(log.createdAt).toLocaleString([], { dateStyle: 'medium', timeStyle: 'short' })}</span>
                       </div>
                       <p className="font-bold text-white text-[15px]">{log.action}</p>
                       {log.metadata?.goal && (
                         <p className="text-slate-200 mt-2 font-medium italic border-l-2 border-[#008A32] pl-3">"{log.metadata.goal}"</p>
                       )}
                     </div>
                  </div>
                ))
