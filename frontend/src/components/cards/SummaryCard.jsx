...
export default function SummaryCard({ title, value, percentage, isPositive, icon: Icon, colorTheme = 'blue', onClick }) {
  const colorClasses = {
    ...
    purple: 'from-purple-500 to-fuchsia-600 text-purple-400 bg-purple-500/10',
    ...
    >
      ...
      <div className="flex justify-between items-start mb-4 relative z-10">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-slate-400 font-semibold text-sm uppercase tracking-widest">{title}</h3>
        </div>
        {percentage && (
