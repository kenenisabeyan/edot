...
export default function Footer() {
  return (
    <footer className="bg-[#0B0E14] border-t border-white/10 text-slate-200 font-sans mt-auto relative overflow-hidden" role="contentinfo">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-24 pb-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-4 flex flex-col pr-0 lg:pr-8">
            ...
            <p className="text-slate-300 font-medium text-sm leading-relaxed mb-10">
            ...
            <div className="flex flex-col gap-5">
               <a href="mailto:support@edot.platform" className="flex items-center gap-4 text-slate-200 hover:text-white transition-colors group">
               ...
               <a href="tel:+251900123456" className="flex items-center gap-4 text-slate-200 hover:text-white transition-colors group">
               ...
               <div className="flex items-center gap-4 text-slate-200 group">
          ...
          <div className="lg:col-span-2">
             ...
             <ul className="space-y-4">
                <li><Link to="/courses?cat=Programming" className="text-slate-200 text-[10px] font-black uppercase tracking-widest hover:text-white transition-colors flex items-center gap-2 group"><ChevronRight className="w-3 h-3 text-[#FFD700] opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all"/> Programming</Link></li>
                <li><Link to="/courses?cat=Business" className="text-slate-200 text-[10px] font-black uppercase tracking-widest hover:text-white transition-colors flex items-center gap-2 group"><ChevronRight className="w-3 h-3 text-[#FFD700] opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all"/> Business</Link></li>
                <li><Link to="/courses?cat=PersonalDev" className="text-slate-200 text-[10px] font-black uppercase tracking-widest hover:text-white transition-colors flex items-center gap-2 group"><ChevronRight className="w-3 h-3 text-[#FFD700] opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all"/> Personal Dev</Link></li>
             </ul>
          </div>

          {/* 4. PLATFORM */}
          <div className="lg:col-span-2">
             <h4 className="text-slate-300 font-black text-[10px] uppercase tracking-[0.2em] mb-8">Platform</h4>
             <ul className="space-y-4">
                <li><Link to="/about" className="text-slate-200 text-[10px] font-black uppercase tracking-widest hover:text-white transition-colors block">About EDOT</Link></li>
                <li><Link to="/courses" className="text-slate-200 text-[10px] font-black uppercase tracking-widest hover:text-white transition-colors block">Full Catalog</Link></li>
                <li><Link to="/register" className="text-slate-200 text-[10px] font-black uppercase tracking-widest hover:text-white transition-colors block">Join Platform</Link></li>
          ...
          {/* 5. SUPPORT */}
          <div className="lg:col-span-2">
             <h4 className="text-slate-300 font-black text-[10px] uppercase tracking-[0.2em] mb-8">Support</h4>
             <ul className="space-y-4">
                <li><Link to="/contact" className="text-slate-200 text-[10px] font-black uppercase tracking-widest hover:text-white transition-colors block">Contact Us</Link></li>
                <li><Link to="/contact" className="text-slate-200 text-[10px] font-black uppercase tracking-widest hover:text-white transition-colors block">FAQ</Link></li>
                <li><Link to="/privacy" className="text-slate-300 text-[10px] font-black uppercase tracking-widest hover:text-slate-300 transition-colors block">Privacy Policy</Link></li>
                <li><Link to="/terms" className="text-slate-300 text-[10px] font-black uppercase tracking-widest hover:text-slate-300 transition-colors block">Terms of Service</Link></li>
             </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left text-slate-300 text-xs font-black uppercase tracking-widest">
          ...
          <div className="flex items-center gap-4 bg-[#11151F] border border-white/5 rounded-full p-1.5">
            <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-full flex items-center justify-center text-slate-300 hover:text-white hover:bg-[#0A66C2] transition-colors">
              <Linkedin className="w-4 h-4" />
            </a>
            <a href="#" aria-label="GitHub" className="w-10 h-10 rounded-full flex items-center justify-center text-slate-300 hover:text-white hover:bg-[#333] transition-colors">
              <Github className="w-4 h-4" />
            </a>
            <a href="#" aria-label="Telegram" className="w-10 h-10 rounded-full flex items-center justify-center text-slate-300 hover:text-white hover:bg-[#229ED9] transition-colors">
