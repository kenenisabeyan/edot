            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-4">
                ...
                <button 
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 border border-slate-300 rounded-md shadow-sm text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                >
            ...
            {isAuthenticated ? (
              ...
              <div className="px-4 flex flex-col gap-3">
                <Link
                  to="/login"
                  onClick={toggleMenu}
                  className="flex w-full items-center justify-center gap-2 px-4 py-2 border border-slate-300 rounded-md shadow-sm text-base font-medium text-slate-700 bg-white hover:bg-slate-50"
                >
